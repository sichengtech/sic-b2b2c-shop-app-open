<template>
	<view class="load-more">
		...
		<text class="loading-text" :style="{color:color}">{{$t(loadingType === 0 ? contentText.contentdown : (loadingType === 1 ? contentText.contentrefresh : contentText.contentnomore) )}}</text>
	</view>
</template>
