<template>
	<view>
		...
		>
			...
			<view class="right_info" style="width: 100%; margin-left: 0px; margin-right: 10px;"><slot style="width: 100%;" name="right"></slot></view>
		</view>
		<view
		...
		>
			...
			<view class="right_info" style="margin-right: 10px;"><slot name="transparentFixedRight"></slot></view>
		</view>
...
const mainPagePath = ["pages/tabBar/index/index", "pages/tabBar/category/category", "pages/tabBar/tradeCart/tradeCart", "pages/tabBar/userCenter/userCenter"];
//返回首页的地址
const homePath = "/pages/tabBar/index/index";
//白色表达值
...
export default {
	...
	created() {
		...
		console.log(this.firstPage, currentPages)
...
.header {
	...
	&.colorWhite {
		.left_info {
			...
			.back {
				background-image: url('~@/static/zhouWei-navBar/back-0.png');
			}
			text {
				background-color: rgba(255, 255, 255, 0.3);
			}
			.home {
				background-image: url('~@/static/zhouWei-navBar/home-0.png');
			}
		}
	}
	.left_box {
